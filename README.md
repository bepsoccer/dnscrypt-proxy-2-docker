[![Docker Cloud Build Status](https://img.shields.io/docker/cloud/build/bepsoccer/dnscrypt-proxy-2-docker.svg)](https://hub.docker.com/r/bepsoccer/dnscrypt-proxy-2-docker)
